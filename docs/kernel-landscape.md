...
Kernel 6.19+ --- RKNPU (DKMS, this project) - RKNN SDK works (goal)
```

## Key Resources

- [w568w/rknpu-module](https://github.com/w568w/rknpu-module) -- Proved DKMS approach works on RK3566 + kernel 6.19.3
- [rockchip-linux/kernel](https://github.com/rockchip-linux/kernel) -- Vendor BSP kernel source (branches: develop-5.10, develop-6.1, develop-6.6)
- [airockchip/rknn-llm](https://github.com/airockchip/rknn-llm) -- Official RKNN-LLM runtime and vendor driver source
- [Armbian](https://www.armbian.com/) -- Community Linux distributions for ARM boards
